...
# -*- coding: utf-8 -*-
#
# utilities/tools/generate_api_reference.py
#
...
#
# Altered generator script that produces markdown files to populate the hifi docs (as stub impls)
# Also adds links, etc., which would be incredibly tedious to write by hand.
#
